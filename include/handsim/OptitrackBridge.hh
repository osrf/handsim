...
namespace haptix
{
  namespace tracking
  {
    ...
    /// (x, y, z, qx, qy, qz, qw).
    typedef std::map<std::string, std::array<float, 7>> RigidBody_M;
    ...
    class OptitrackBridgeComms
    {
        ...
        private: size_t MsgLength(const RigidBody_M &_trackingInfo);
        ...
        private: size_t Pack(const RigidBody_M &_trackingInfo,
