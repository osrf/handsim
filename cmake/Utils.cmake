...
#################################################
macro (handsim_add_library _name)
  add_library(${_name} SHARED ${ARGN})
  target_link_libraries (${_name} ${general_libraries})
endmacro ()

#################################################
macro (handsim_add_static_library _name)
  add_library(${_name} STATIC ${ARGN})
  target_link_libraries (${_name} ${general_libraries})
endmacro ()

#################################################
macro (handsim_add_executable _name)
...
#################################################
macro (handsim_install_executable _name)
...
#################################################
macro (handsim_setup_unix)
endmacro()

#################################################
macro (handsim_setup_windows)
endmacro()

#################################################
macro (handsim_setup_apple)
